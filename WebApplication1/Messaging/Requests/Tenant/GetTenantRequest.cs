...
{
    public class GetTenantRequest : IGetTenantRequest
    {
        private readonly IActionContextAccessor actionContextAccessor;
        private readonly ITenantRepository tenantRepository;
        private readonly IMapper<Data.Tenant, ViewModels.Tenant> tenantMapper;

        public GetTenantRequest(IActionContextAccessor actionContextAccessor, ITenantRepository tenantRepository, IMapper<Data.Tenant, ViewModels.Tenant> tenantMapper)
        {
        ...
        {
            var tenant = await tenantRepository.Get(parameter, cancellationToken).ConfigureAwait(false);
            if(tenant is null)
            {
